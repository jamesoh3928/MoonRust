use nom::{
    branch::alt,
    bytes::{
        complete::{is_not, take_while_m_n},
        streaming::tag,
    },
...
pub fn parse_string<'a>(input: &'a str) -> IResult<&'a str, String> {
    ...
    // TODO: Handle both single and double quotes
